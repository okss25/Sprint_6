class TestData:
    test_data_user1 = ['Барсик', 'Москва', 'ул Мясницкая, 16', 'Черкизовская', '+780124678935', '25.05.2026',
                 ' Распогодилось']

    test_data_user2 = ['Kitsi', 'Санкт - Петербург', 'ул Баталова, 4', 'Фрунзенская', '+79123456780', '28.05.2026',
